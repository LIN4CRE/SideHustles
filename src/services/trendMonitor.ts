...
export const INITIAL_TRENDING_REPOS: TrendingRepo[] = [
  ...
  },
  {
    ...
    description: 'MCP server that automatically creates PayPal checkout links, tracks direct bank sorting codes (••-••-30), and verifies client payments.',
    ...
    convertedHustle: {
      ...
      weeklyHoursNeeded: 1,
      difficulty: 'Beginner',
      description: 'Automatically injects bank routing (••-••-30 / ••••3968) and PayPal.me credentials into client proposals to close sales instantly.',
